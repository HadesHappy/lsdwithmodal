...
const DappSectionHeader = () => {
  ...
  return (
    <>
      ...
      <button style={{ color: 'white', backgroundColor: '#3ED4C2', borderRadius: 5, position: 'absolute', left: 15, top: 15, paddingTop: 5, paddingBottom: 5, paddingRight: 10, paddingLeft: 10, cursor: 'pointer' }} onClick={() => setIsInfoModalVisible(true)}>Stake Info</button>
        ...
        <ModalWindow>
          <div className="modal-window__wrapper modal-window__wrapper--select-token">
            <header className="modal-window__header">
              <h2 style={{ marginBottom: 30 }}>Info Title</h2>
              <button className="modal-window__close" onClick={() => setIsInfoModalVisible(false)}></button>
            </header>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo ex mollitia, unde porro cum veritatis fugiat molestias quas praesentium nemo?</p>
          </div>
